                        ...
                        <tbody>
                            @foreach ($Donations as $Donation)
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-warning btn-sm">قيد المراجعة</button></td>
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item"
                                                    href="{{ route('Approved_Donation', $Donation->id) }}"><i
                                                        style="color: green" class="fa fa-check"></i>&nbsp; الموافقة على
                                                    الصدقة</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('Rejected_Donation', $Donation->id) }}"><i
                                                        style="color:rgb(202, 62, 62)" class="fa fa-times"></i>&nbsp;
                                                    إلغاء الصدقة</a>
                                            </div>
                                        </div>
                                    </td>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            // تعريف lightbox مع تحسينات الإغلاق
            lightbox.option({
                'resizeDuration': 200,
                'wrapAround': true,
                ...
                'onClosed': function() {
                    // التأكد من إغلاق المودال الرئيسي
            ...
            // إصلاح نهائي لمشكلة الإغلاق
            $(document).on('click', '.lb-close, .lightbox-overlay', function() {
                $('#imagesModal').modal('hide');
            });
